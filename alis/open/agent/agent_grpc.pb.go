...
const (
	A2AService_SendMessage_FullMethodName                      = "/alis.open.agent.v1.A2AService/SendMessage"
	A2AService_SendStreamingMessage_FullMethodName             = "/alis.open.agent.v1.A2AService/SendStreamingMessage"
	A2AService_GetTask_FullMethodName                          = "/alis.open.agent.v1.A2AService/GetTask"
	A2AService_ListTasks_FullMethodName                        = "/alis.open.agent.v1.A2AService/ListTasks"
	A2AService_CancelTask_FullMethodName                       = "/alis.open.agent.v1.A2AService/CancelTask"
	A2AService_TaskSubscription_FullMethodName                 = "/alis.open.agent.v1.A2AService/TaskSubscription"
	A2AService_CreateTaskPushNotificationConfig_FullMethodName = "/alis.open.agent.v1.A2AService/CreateTaskPushNotificationConfig"
	A2AService_GetTaskPushNotificationConfig_FullMethodName    = "/alis.open.agent.v1.A2AService/GetTaskPushNotificationConfig"
	A2AService_ListTaskPushNotificationConfig_FullMethodName   = "/alis.open.agent.v1.A2AService/ListTaskPushNotificationConfig"
	A2AService_GetAgentCard_FullMethodName                     = "/alis.open.agent.v1.A2AService/GetAgentCard"
	A2AService_DeleteTaskPushNotificationConfig_FullMethodName = "/alis.open.agent.v1.A2AService/DeleteTaskPushNotificationConfig"
)
...
func (UnimplementedA2AServiceServer) TaskSubscription(*TaskSubscriptionRequest, grpc.ServerStreamingServer[StreamResponse]) error {
	return status.Error(codes.Unimplemented, "method TaskSubscription not implemented")
}
...
func (UnimplementedA2AServiceServer) ListTaskPushNotificationConfig(context.Context, *ListTaskPushNotificationConfigRequest) (*ListTaskPushNotificationConfigResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListTaskPushNotificationConfig not implemented")
}
...
var A2AService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "alis.open.agent.v1.A2AService",
	...
	Metadata: "alis/open/agent/v1/agent.proto",
}
