...
type TaskStatus struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	State         TaskState              `protobuf:"varint,1,opt,name=state,proto3,enum=alis.open.agent.v1.TaskState" json:"state,omitempty"`
...
type ListTasksRequest struct {
	...
	Status           TaskState              `protobuf:"varint,2,opt,name=status,proto3,enum=alis.open.agent.v1.TaskState" json:"status,omitempty"`
...
const file_alis_open_agent_v1_agent_proto_rawDesc = "" +
	...
	"\bmetadata\x18\a \x01(\v2\x17.google.protobuf.StructR\bmetadata\"\xb1\x01\n" +
	"\n" +
	"TaskStatus\x123\n" +
	"\x05state\x18\x01 \x01(\x0e2\x1d.alis.open.agent.v1.TaskStateR\x05state\x124\n" +
	"\x06update\x18\x02 \x01(\v2\x1b.alis.open.agent.v1.MessageR\amessage\x128\n" +
	...
	"\x03any\x18\x14 \x01(\v2\x14.google.protobuf.AnyH\x00R\x03any\x123\n" +
	...
	"\bsecurity\x18\b \x03(\v2\x1c.alis.open.agent.v1.SecurityR\bsecurity\"\x8d\x01\n" +
	...
	"\x18push_notification_config\x18\x02 \x01(\v2*.alis.open.agent.v1.PushNotificationConfigR\x16pushNotificationConfig\" \n" +
	"\n" +
	"StringList\x12\x12\n" +
	"\x04list\x18\x01 \x03(\tR\x04list\"\xab\x01\n" +
	"\bSecurity\x12C\n" +
	"\aschemes\x18\x01 \x03(\v2).alis.open.agent.v1.Security.SchemesEntryR\aschemes\x1aZ\n" +
	"\fSchemesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x124\n" +
	"\x05value\x18\x02 \x01(\v2\x1e.alis.open.agent.v1.StringListR\x05value:\x028\x01\"\xa2\x04\n" +
	...
	"\arequest\x18\x01 \x01(\v2\x1b.alis.open.agent.v1.MessageB\x04\xe2A\x01\x02R\amessage\x12R\n" +
	...
	"\x06status\x18\x02 \x01(\x0e2\x1d.alis.open.agent.v1.TaskStateR\x06status\x12\x1b\n" +
	...
	"\x11include_artifacts\x18\a \x01(\bR\x10includeArtifacts\"'\n" +
	...
	"\x06config\x18\x03 \x01(\v2..alis.open.agent.v1.TaskPushNotificationConfigB\x04\xe2A\x01\x02R\x06config\"-\n" +
	...
	"\x04task\x18\x01 \x01(\v2\x18.alis.open.agent.v1.TaskH\x00R\x04task\x123\n" +
	"\x03msg\x18\x02 \x01(\v2\x1b.alis.open.agent.v1.MessageH\x00R\amessageB\t\n" +
	"\apayload\"\xaa\x02\n" +
	"\x0eStreamResponse\x12.\n" +
	"\x04task\x18\x01 \x01(\v2\x18.alis.open.agent.v1.TaskH\x00R\x04task\x123\n" +
	"\x03msg\x18\x02 \x01(\v2\x1b.alis.open.agent.v1.MessageH\x00R\amessage\x12P\n" +
	...
	"\n" +
	"A2AService\x12{\n" +
	"\vSendMessage\x12&.alis.open.agent.v1.SendMessageRequest\x1a'.alis.open.agent.v1.SendMessageResponse\"\x1b\x82\xd3\xe4\x93\x02\x15:\x01*\"\x10/v1/message:send\x12\x83\x01\n" +
	"\x14SendStreamingMessage\x12&.alis.open.agent.v1.SendMessageRequest\x1a\".alis.open.agent.v1.StreamResponse\"\x1d\x82\xd3\xe4\x93\x02\x17:\x01*\"\x12/v1/message:stream0\x01\x12j\n" +
	"\aGetTask\x12\".alis.open.agent.v1.GetTaskRequest\x1a\x18.alis.open.agent.v1.Task\"!\xdaA\x04name\x82\xd3\xe4\x93\x02\x14\x12\x12/v1/{name=tasks/*}\x12k\n" +
	"\tListTasks\x12$.alis.open.agent.v1.ListTasksRequest\x1a%.alis.open.agent.v1.ListTasksResponse\"\x11\x82\xd3\xe4\x93\x02\v\x12\t/v1/tasks\x12s\n" +
	"\n" +
	"CancelTask\x12%.alis.open.agent.v1.CancelTaskRequest\x1a\x18.alis.open.agent.v1.Task\"$\x82\xd3\xe4\x93\x02\x1e:\x01*\"\x19/v1/{name=tasks/*}:cancel\x12\x8b\x01\n" +
	...
	" CreateTaskPushNotificationConfig\x12;.alis.open.agent.v1.CreateTaskPushNotificationConfigRequest\x1a..alis.open.agent.v1.TaskPushNotificationConfig\"L\xdaA\rparent,config\x82\xd3\xe4\x93\x026:\x06config\",/v1/{parent=tasks/*/pushNotificationConfigs}\x12\xc6\x01\n" +
	"\x1dGetTaskPushNotificationConfig\x128.alis.open.agent.v1.GetTaskPushNotificationConfigRequest\x1a..alis.open.agent.v1.TaskPushNotificationConfig\";\xdaA\x04name\x82\xd3\xe4\x93\x02.\x12,/v1/{name=tasks/*/pushNotificationConfigs/*}\x12\xd6\x01\n" +
	"\x1eListTaskPushNotificationConfig\x129.alis.open.agent.v1.ListTaskPushNotificationConfigRequest\x1a:.alis.open.agent.v1.ListTaskPushNotificationConfigResponse\"=\xdaA\x06parent\x82\xd3\xe4\x93\x02.\x12,/v1/{parent=tasks/*}/pushNotificationConfigs\x12h\n" +
	"\fGetAgentCard\x12'.alis.open.agent.v1.GetAgentCardRequest\x1a\x1d.alis.open.agent.v1.AgentCard\"\x10\x82\xd3\xe4\x93\x02\n" +
	"\x12\b/v1/card\x12\xb4\x01\n" +
	" DeleteTaskPushNotificationConfig\x12;.alis.open.agent.v1.DeleteTaskPushNotificationConfigRequest\x1a\x16.google.protobuf.Empty\";\xdaA\x04name\x82\xd3\xe4\x93\x02.*,/v1/{name=tasks/*/pushNotificationConfigs/*}B4Z2github.com/alis-build/public-go/alis/open/agent/v1b\x06proto3"
...
var file_alis_open_agent_v1_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 53)
var file_alis_open_agent_v1_agent_proto_goTypes = []any{
	...
	nil,                           // 50: alis.open.agent.v1.Security.SchemesEntry
	nil,                           // 51: alis.open.agent.v1.AuthorizationCodeOAuthFlow.ScopesEntry
	nil,                           // 52: alis.open.agent.v1.ClientCredentialsOAuthFlow.ScopesEntry
	nil,                           // 53: alis.open.agent.v1.ImplicitOAuthFlow.ScopesEntry
	nil,                           // 54: alis.open.agent.v1.PasswordOAuthFlow.ScopesEntry
...
var file_alis_open_agent_v1_agent_proto_depIdxs = []int32{
	...
	55, // 4: alis.open.agent.v1.Task.metadata:type_name -> google.protobuf.Struct
	...
	56, // 7: alis.open.agent.v1.TaskStatus.timestamp:type_name -> google.protobuf.Timestamp
	6,  // 8: alis.open.agent.v1.Part.file:type_name -> alis.open.agent.v1.FilePart
	7,  // 9: alis.open.agent.v1.Part.data:type_name -> alis.open.agent.v1.DataPart
	57, // 10: alis.open.agent.v1.Part.any:type_name -> google.protobuf.Any
	55, // 11: alis.open.agent.v1.Part.metadata:type_name -> google.protobuf.Struct
	55, // 12: alis.open.agent.v1.DataPart.data:type_name -> google.protobuf.Struct
	1,  // 13: alis.open.agent.v1.Message.role:type_name -> alis.open.agent.v1.Role
	5,  // 14: alis.open.agent.v1.Message.parts:type_name -> alis.open.agent.v1.Part
	55, // 15: alis.open.agent.v1.Message.metadata:type_name -> google.protobuf.Struct
	5,  // 16: alis.open.agent.v1.Artifact.parts:type_name -> alis.open.agent.v1.Part
	55, // 17: alis.open.agent.v1.Artifact.metadata:type_name -> google.protobuf.Struct
	4,  // 18: alis.open.agent.v1.TaskStatusUpdateEvent.status:type_name -> alis.open.agent.v1.TaskStatus
	55, // 19: alis.open.agent.v1.TaskStatusUpdateEvent.metadata:type_name -> google.protobuf.Struct
	9,  // 20: alis.open.agent.v1.TaskArtifactUpdateEvent.artifact:type_name -> alis.open.agent.v1.Artifact
	55, // 21: alis.open.agent.v1.TaskArtifactUpdateEvent.metadata:type_name -> google.protobuf.Struct
	13, // 22: alis.open.agent.v1.PushNotificationConfig.authentication:type_name -> alis.open.agent.v1.AuthenticationInfo
	14, // 23: alis.open.agent.v1.AgentCard.additional_interfaces:type_name -> alis.open.agent.v1.AgentInterface
	16, // 24: alis.open.agent.v1.AgentCard.provider:type_name -> alis.open.agent.v1.AgentProvider
	17, // 25: alis.open.agent.v1.AgentCard.capabilities:type_name -> alis.open.agent.v1.AgentCapabilities
	49, // 26: alis.open.agent.v1.AgentCard.security_schemes:type_name -> alis.open.agent.v1.AgentCard.SecuritySchemesEntry
	23, // 27: alis.open.agent.v1.AgentCard.security:type_name -> alis.open.agent.v1.Security
	19, // 28: alis.open.agent.v1.AgentCard.skills:type_name -> alis.open.agent.v1.AgentSkill
	20, // 29: alis.open.agent.v1.AgentCard.signatures:type_name -> alis.open.agent.v1.AgentCardSignature
	18, // 30: alis.open.agent.v1.AgentCapabilities.extensions:type_name -> alis.open.agent.v1.AgentExtension
	55, // 31: alis.open.agent.v1.AgentExtension.params:type_name -> google.protobuf.Struct
	23, // 32: alis.open.agent.v1.AgentSkill.security:type_name -> alis.open.agent.v1.Security
	55, // 33: alis.open.agent.v1.AgentCardSignature.header:type_name -> google.protobuf.Struct
	12, // 34: alis.open.agent.v1.TaskPushNotificationConfig.push_notification_config:type_name -> alis.open.agent.v1.PushNotificationConfig
	50, // 35: alis.open.agent.v1.Security.schemes:type_name -> alis.open.agent.v1.Security.SchemesEntry
	25, // 36: alis.open.agent.v1.SecurityScheme.api_key_security_scheme:type_name -> alis.open.agent.v1.APIKeySecurityScheme
	26, // 37: alis.open.agent.v1.SecurityScheme.http_auth_security_scheme:type_name -> alis.open.agent.v1.HTTPAuthSecurityScheme
	27, // 38: alis.open.agent.v1.SecurityScheme.oauth2_security_scheme:type_name -> alis.open.agent.v1.OAuth2SecurityScheme
	28, // 39: alis.open.agent.v1.SecurityScheme.open_id_connect_security_scheme:type_name -> alis.open.agent.v1.OpenIdConnectSecurityScheme
	29, // 40: alis.open.agent.v1.SecurityScheme.mtls_security_scheme:type_name -> alis.open.agent.v1.MutualTlsSecurityScheme
	30, // 41: alis.open.agent.v1.OAuth2SecurityScheme.flows:type_name -> alis.open.agent.v1.OAuthFlows
	31, // 42: alis.open.agent.v1.OAuthFlows.authorization_code:type_name -> alis.open.agent.v1.AuthorizationCodeOAuthFlow
	32, // 43: alis.open.agent.v1.OAuthFlows.client_credentials:type_name -> alis.open.agent.v1.ClientCredentialsOAuthFlow
	33, // 44: alis.open.agent.v1.OAuthFlows.implicit:type_name -> alis.open.agent.v1.ImplicitOAuthFlow
	34, // 45: alis.open.agent.v1.OAuthFlows.password:type_name -> alis.open.agent.v1.PasswordOAuthFlow
	51, // 46: alis.open.agent.v1.AuthorizationCodeOAuthFlow.scopes:type_name -> alis.open.agent.v1.AuthorizationCodeOAuthFlow.ScopesEntry
	52, // 47: alis.open.agent.v1.ClientCredentialsOAuthFlow.scopes:type_name -> alis.open.agent.v1.ClientCredentialsOAuthFlow.ScopesEntry
	53, // 48: alis.open.agent.v1.ImplicitOAuthFlow.scopes:type_name -> alis.open.agent.v1.ImplicitOAuthFlow.ScopesEntry
	54, // 49: alis.open.agent.v1.PasswordOAuthFlow.scopes:type_name -> alis.open.agent.v1.PasswordOAuthFlow.ScopesEntry
	8,  // 50: alis.open.agent.v1.SendMessageRequest.request:type_name -> alis.open.agent.v1.Message
	2,  // 51: alis.open.agent.v1.SendMessageRequest.configuration:type_name -> alis.open.agent.v1.SendMessageConfiguration
	55, // 52: alis.open.agent.v1.SendMessageRequest.metadata:type_name -> google.protobuf.Struct
	0,  // 53: alis.open.agent.v1.ListTasksRequest.status:type_name -> alis.open.agent.v1.TaskState
	56, // 54: alis.open.agent.v1.ListTasksRequest.last_updated_time:type_name -> google.protobuf.Timestamp
	21, // 55: alis.open.agent.v1.CreateTaskPushNotificationConfigRequest.config:type_name -> alis.open.agent.v1.TaskPushNotificationConfig
	3,  // 56: alis.open.agent.v1.SendMessageResponse.task:type_name -> alis.open.agent.v1.Task
	8,  // 57: alis.open.agent.v1.SendMessageResponse.msg:type_name -> alis.open.agent.v1.Message
	3,  // 58: alis.open.agent.v1.StreamResponse.task:type_name -> alis.open.agent.v1.Task
	8,  // 59: alis.open.agent.v1.StreamResponse.msg:type_name -> alis.open.agent.v1.Message
	10, // 60: alis.open.agent.v1.StreamResponse.status_update:type_name -> alis.open.agent.v1.TaskStatusUpdateEvent
	11, // 61: alis.open.agent.v1.StreamResponse.artifact_update:type_name -> alis.open.agent.v1.TaskArtifactUpdateEvent
	3,  // 62: alis.open.agent.v1.ListTasksResponse.tasks:type_name -> alis.open.agent.v1.Task
	21, // 63: alis.open.agent.v1.ListTaskPushNotificationConfigResponse.configs:type_name -> alis.open.agent.v1.TaskPushNotificationConfig
	24, // 64: alis.open.agent.v1.AgentCard.SecuritySchemesEntry.value:type_name -> alis.open.agent.v1.SecurityScheme
	22, // 65: alis.open.agent.v1.Security.SchemesEntry.value:type_name -> alis.open.agent.v1.StringList
	35, // 66: alis.open.agent.v1.A2AService.SendMessage:input_type -> alis.open.agent.v1.SendMessageRequest
	35, // 67: alis.open.agent.v1.A2AService.SendStreamingMessage:input_type -> alis.open.agent.v1.SendMessageRequest
	36, // 68: alis.open.agent.v1.A2AService.GetTask:input_type -> alis.open.agent.v1.GetTaskRequest
	37, // 69: alis.open.agent.v1.A2AService.ListTasks:input_type -> alis.open.agent.v1.ListTasksRequest
	38, // 70: alis.open.agent.v1.A2AService.CancelTask:input_type -> alis.open.agent.v1.CancelTaskRequest
	42, // 71: alis.open.agent.v1.A2AService.TaskSubscription:input_type -> alis.open.agent.v1.TaskSubscriptionRequest
	41, // 72: alis.open.agent.v1.A2AService.CreateTaskPushNotificationConfig:input_type -> alis.open.agent.v1.CreateTaskPushNotificationConfigRequest
	39, // 73: alis.open.agent.v1.A2AService.GetTaskPushNotificationConfig:input_type -> alis.open.agent.v1.GetTaskPushNotificationConfigRequest
	43, // 74: alis.open.agent.v1.A2AService.ListTaskPushNotificationConfig:input_type -> alis.open.agent.v1.ListTaskPushNotificationConfigRequest
	44, // 75: alis.open.agent.v1.A2AService.GetAgentCard:input_type -> alis.open.agent.v1.GetAgentCardRequest
	40, // 76: alis.open.agent.v1.A2AService.DeleteTaskPushNotificationConfig:input_type -> alis.open.agent.v1.DeleteTaskPushNotificationConfigRequest
	45, // 77: alis.open.agent.v1.A2AService.SendMessage:output_type -> alis.open.agent.v1.SendMessageResponse
	46, // 78: alis.open.agent.v1.A2AService.SendStreamingMessage:output_type -> alis.open.agent.v1.StreamResponse
	3,  // 79: alis.open.agent.v1.A2AService.GetTask:output_type -> alis.open.agent.v1.Task
	47, // 80: alis.open.agent.v1.A2AService.ListTasks:output_type -> alis.open.agent.v1.ListTasksResponse
	3,  // 81: alis.open.agent.v1.A2AService.CancelTask:output_type -> alis.open.agent.v1.Task
	46, // 82: alis.open.agent.v1.A2AService.TaskSubscription:output_type -> alis.open.agent.v1.StreamResponse
	21, // 83: alis.open.agent.v1.A2AService.CreateTaskPushNotificationConfig:output_type -> alis.open.agent.v1.TaskPushNotificationConfig
	21, // 84: alis.open.agent.v1.A2AService.GetTaskPushNotificationConfig:output_type -> alis.open.agent.v1.TaskPushNotificationConfig
	48, // 85: alis.open.agent.v1.A2AService.ListTaskPushNotificationConfig:output_type -> alis.open.agent.v1.ListTaskPushNotificationConfigResponse
	15, // 86: alis.open.agent.v1.A2AService.GetAgentCard:output_type -> alis.open.agent.v1.AgentCard
	58, // 87: alis.open.agent.v1.A2AService.DeleteTaskPushNotificationConfig:output_type -> google.protobuf.Empty
